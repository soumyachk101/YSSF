          ...
          <AnimatePresence mode="wait">
            ...
            {step === 3 && (
              <motion.div
                ...
                exit={{ opacity: 0, x: -20 }}
                transition={{ duration: 0.2 }}
                className="space-y-6 flex-grow flex flex-col justify-center text-center py-6"
              >
                {/* Header & Icon */}
                <div className="space-y-4">
                  <div className="w-16 h-16 bg-primary-900/10 text-primary-900 rounded-full flex items-center justify-center mx-auto">
                    <Mail className="w-8 h-8 animate-bounce" />
                  </div>
                  <h1 className="font-heading font-black text-2xl text-primary-900 leading-none tracking-tight">
                    Verify Your Email
                  </h1>
                  <p className="font-sans text-sm text-primary-900/70 font-semibold leading-relaxed max-w-sm mx-auto">
                    We have sent a verification link to <span className="text-primary-900 font-extrabold">{email}</span>. Please check your inbox and click the link to activate your account.
                  </p>
                </div>
                ...
                <div className="space-y-4 pt-4">
                  ...
                  <div className="pt-2">
                    <Link
                      href="/login"
                      className="font-heading font-bold text-xs text-primary-900 hover:text-primary-800 underline"
                    >
                      Back to Sign In
                    </Link>
                  </div>
